...
- **Admin** — operates the standalone admin dashboard for oversight, settlement, and risk review.
...
| Consumer Wallet Liability | Liability | MSP owed to consumers |
| Merchant Settlement Payable | Liability | Real currency owed to a merchant for MSP collected |
