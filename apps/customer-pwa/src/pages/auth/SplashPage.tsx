...
export default function SplashPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#050505] relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-primary/20 blur-[100px] animate-pulse" />
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 animate-fade-in">
        <div className="w-24 h-24 rounded-[32px] bg-white/5 backdrop-blur-2xl border border-white/10 flex items-center justify-center shadow-[0_0_40px_rgba(255,93,143,0.15)] relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-50" />
          <span className="text-4xl font-bold text-white font-sora tracking-tight relative z-10 drop-shadow-md">M</span>
        </div>

        <div className="text-center mt-2">
          <h1 className="text-4xl font-bold text-white tracking-tight drop-shadow-sm">MS Pay</h1>
          <p className="text-white/60 text-sm mt-3 font-medium tracking-wide">YOUR VIRTUAL WALLET</p>
        </div>
      </div>
